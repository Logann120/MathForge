...
- Selecting topic-aware difficulty options: Easy for all topics, plus Medium
  and Hard for linear equations and quadratic equations by factoring
...
- Medium and Hard are currently exposed only for linear equations and quadratic equations by factoring; systems, factoring techniques, and functions basics remain Easy-only.
