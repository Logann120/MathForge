...
@pytest.mark.parametrize("difficulty", ("medium", "hard"))
def test_generate_systems_of_equations_resource_pack_passes_through_difficulty(
    difficulty: str,
) -> None:
    resource_pack = generate_systems_of_equations_resource_pack(
        topic="Systems of linear equations",
...
@pytest.mark.parametrize("difficulty", ("medium", "hard"))
def test_generate_factoring_techniques_resource_pack_passes_through_difficulty(
    difficulty: str,
) -> None:
    resource_pack = generate_factoring_techniques_resource_pack(
        topic="Factoring techniques",
        difficulty=difficulty,
        count=2,
        start_id=f"{difficulty}-factoring",
    )
...
@pytest.mark.parametrize("difficulty", ("medium", "hard"))
def test_generate_functions_basics_resource_pack_passes_through_difficulty(
    difficulty: str,
) -> None:
    resource_pack = generate_functions_basics_resource_pack(
        topic="Functions basics",
        difficulty=difficulty,
        count=2,
        start_id=f"{difficulty}-functions",
    )
